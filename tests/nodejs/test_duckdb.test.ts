...
function buildDuckDbTypeCoverageCase(tableName: string): TypeCoverageCase {
  return {
...
function assertDuckDbTypeCoverageValues(resultSet: ResultSet): void {
...
const duckDbTestFn = async (t: TestContext): Promise<void> => {
